...
const renderContent = {
    1: (
        <h1 className= "sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5">Hi, I am <span className="font-semibold">Srikanth</span>👨‍💻  <br/>
        A software Engineer from France</h1>
